...
const PhoneBox = ()=>{
    ...
    const [isVisibleLoginWithMyPhone, setVisibleLoginWithMyPhone] = useState(true);
    ...
    return(
        <div style={{display:'flex',justifyContent:'center', alignItems:'center', flexDirection:'column', padding:40}}>
            ...
            {/* Form Text Password */}
            <div
                className="mb-1" style={{display:'flex',flexDirection:'row', alignItems:'center', flex:1, width:'100%',  borderBottom:'0.5px solid silver', paddingBottom:2}}
            ...
            >
                <Button
                    variant="light"
                    style={{paddingRight:'20px', paddingLeft:'20px', border:'1px solid #cfcfcf'}}
                    onClick={()=>{setVisibleLoginWithMyPhone(false)}}
                >
                    ...
                    >
                        <div style={{flex:1}}>
                            ...
                            >
                                ...
                                <Tab
                                    eventKey="Phone"
                                    title={<span style={{ color:'black' }}>Với số điện thoại</span>}
                                >
                                    <PhoneBox/>

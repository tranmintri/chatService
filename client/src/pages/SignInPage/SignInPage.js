      ...
      <div className="tw-w-[30rem] md:tw-w-auto tw-bg-dark-1 tw-px-7 tw-py-10 tw-m-5 tw-rounded-md tw-font-medium tw-block md:tw-flex tw-gap-14">
        ...
        {loginQRRequest?.userInfo ? (
          <div className="md:tw-w-[15rem] tw-hidden md:tw-block tw-text-center">
            <div className="tw-w-48 tw-h-48 tw-flex tw-items-center tw-justify-center tw-bg-white p-2 tw-rounded-full tw-mx-auto tw-mb-7">
              <img src={loginQRRequest.userInfo.avatar} alt="" />
            </div>

            {isGenerateQRCodeSuccess &&
              loginQRRequest.status !== "REJECTED" && (
                <p className="tw-text-dark-1 tw-text-sm tw-mb-0 tw-font-semibold">
            ...
            {loginQRRequest.status === "REJECTED" && (
              <>
                <p className="tw-text-red-600 tw-mb-0 tw-font-semibold">
                  Request is Rejected
                </p>
                <button
          ...
          <div className="md:tw-w-[15rem] tw-hidden md:tw-block tw-text-center">
            <div className="tw-w-48 tw-h-48 tw-flex tw-items-center tw-justify-center tw-bg-white p-2 tw-rounded-md tw-mx-auto tw-mb-7">
              ...
              {isGeneratingQRCode && (
                <div className="tw-relative">
                  <img
                    ...
                    alt=""
                  />
                  <div className="tw-absolute tw-text-4xl tw-text-gray-900 tw-top-1/2 tw-left-1/2 -tw-translate-x-1/2 -tw-translate-y-1/2">
            ...
            {isGenerateQRCodeSuccess && (
              <p className="tw-text-dark-1 tw-text-sm tw-font-semibold">
                {String(Math.floor(countDown / 60)).padStart(2, "0")} :{" "}
                {String(countDown % 60).padStart(2, "0")}
              </p>
            )}

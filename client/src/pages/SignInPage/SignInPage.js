                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="tw-mb-5">
                                ...
                                <input
                                    ...
                                    type="text"
                                    {...register("username", {required: "Please enter Email or Phone Number"})}
                                />
...
{errors?.password && <p className="tw-text-red-500 tw-text-sm tw-mt-1">{errors.password.message}</p>}
                    ...
                    <div className="md:tw-w-[15rem] tw-hidden md:tw-block tw-text-center">
                        ...
                        <p className="tw-text-xl tw-text-dark-1 tw-font-bold tw-mb-2">Log in with QR Code</p>
                        <p className="tw-text-dark-2 tw-text-sm">Scan this with the <b>DraFi Mobile App</b> to log in instantly</p>
                    </div>
            </div>
        </div>
    )

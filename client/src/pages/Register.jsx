    ...
    return(
        <div>
            ...
            >
                ...
                {/* Giới tính */}
                <div className="mb-4" style={{display:'flex',flexDirection:'row', alignItems:'center', flex:1, width:'100%', borderBottom:'0.5px solid silver', paddingBottom:2}}>
                    <div style={{display:'flex', flex:1}}>
                        <Form>
                            <Form.Group>
                                <div>

    ...
    return (
        <div className="signup-page tw-w-full tw-min-w-screen tw-h-full tw-min-h-screen tw-flex tw-items-center tw-justify-center">
            <div className="tw-w-[30rem] tw-bg-dark-1 tw-px-7 tw-py-10 tw-m-5 tw-rounded-md tw-font-medium">
                <p className="tw-mb-5 tw-text-dark-1 tw-text-xl tw-font-bold tw-text-center">Create an account</p>
                    ...
                    <div className="tw-grid tw-grid-cols-2 tw-gap-5">
                        <div className="tw-col-span-2">
                            ...
                            <input
                                ...
                                type="text"
                                {...register("displayName", {required: "Please enter Display Name"})}
                            />
                            {errors?.displayName && <p className="tw-text-red-500 tw-text-sm tw-mt-1">{errors.displayName.message}</p>}
                        </div>
                        ...
                        <div className="tw-col-span-2">
                            ...
                            />
                            {errors?.email && <p className="tw-text-red-500 tw-text-sm tw-mt-1">{errors.email.message}</p>}
                        </div>
                        ...
                        <div className="tw-col-span-2">
                            ...
                            />
                            {errors?.username && <p className="tw-text-red-500 tw-text-sm tw-mt-1">{errors.username.message}</p>}
                        </div>
                        ...
                        <div className="tw-col-span-2 md:tw-col-span-1">
                            ...
                            />
                            {errors?.password && <p className="tw-text-red-500 tw-text-sm tw-mt-1">{errors.password.message}</p>}
                        </div>
                        ...
                        <div className="tw-col-span-2 md:tw-col-span-1">
                            ...
                            <input
                                ...
                                {...register("confirmPassword", {
                                    ...
                                    validate: value => password === value || 'Confirm password not match'
                                })}
                            />
                            {errors?.confirmPassword && <p className="tw-text-red-500 tw-text-sm tw-mt-1">{errors.confirmPassword.message}</p>}
                        </div>
                        ...
                        <div className="tw-col-span-2">
                            <div className="tw-text-left tw-text-xs tw-text-dark-2 tw-flex tw-items-center">
                                <div>
                                    ...
                                    />
                                    {acceptanceTerms
                                    ? (<i className="fa-regular fa-square-check fa-xl tw-mr-2"
                                          onClick={() => {
                                              setValue('acceptanceTerms', false);
                                          }}
                                        ></i>)
                                    : (<i className="fa-regular fa-square fa-xl tw-mr-2"
                                          onClick={() => {
                                ...
                                <div className="flex-1">
                                    <label htmlFor="acceptanceTerms">(Optional) It's okey to send me email with DraFi updates, típ, and special ofers. You can opt out at any time.</label>
                                </div>
                            </div>
                            {errors?.acceptanceTerms && <p className="tw-text-red-500 tw-text-sm tw-mt-1">{errors.acceptanceTerms.message}</p>}
                        </div>

                        <div className="tw-col-span-2">
                            <button className="tw-w-full tw-px-4 tw-py-2 tw-rounded-sm tw-font-semibold tw-bg-blue-1 tw-text-dark-1">Continue</button>
                        </div>
                    </div>
                </form>
                ...
                <div>
                    ...
                    >
                        <img
                            className="tw-w-6"
                            src="https://cdn.iconscout.com/icon/free/png-256/free-google-1772223-1507807.png" alt=""/>
                        Sign Up with Google
                    </button>
                </div>

...
const MyAccountPage = () => {
    ...
    return (
        <>
            <div className="tw-px-7 tw-py-10">
                <div className="tw-mb-10">
                    ...
                    >
                        ...
                        <div className="tw-flex tw-items-center tw-px-6 tw-py-3">
                                ...
                                <div className="tw-absolute -tw-top-14 tw-flex tw-gap-3">
                                    ...
                                    <div>
                                        <p className="tw-text-lg tw-font-bold tw-mt-9 tw-mb-0">
                                            {isLoading ? "Loading..." : (userInfo?.display_name || "No Data")}
                                        </p>
                        ...
                        <div
                            className="tw-mx-4 tw-my-7 tw-px-6 tw-py-3 tw-rounded-lg"
                        ...
                        >
                            <div className="tw-flex">
                                <div className="tw-flex-1">
                                    ...
                                    <p>{isLoading ? "Loading..." : (userInfo?.display_name || "No Data")}</p>
                                </div>
                                <div className="text-end">
                                    <button
                            ...
                            <div className="tw-flex">
                                <div className="tw-flex-1">
                                    ...
                                    <p>
                                        {isLoading ? "Loading..." : (userInfo?.username ? `@${userInfo.username}` : "You haven't added any usernames")}
                                    </p>
                                </div>
                                <div className="text-end">
                                    <button
                            ...
                            <div className="tw-flex">
                                <div className="tw-flex-1">
                                    ...
                                    <p>{isLoading ? "Loading..." : (userInfo?.email || "You haven't added any emails")}</p>
                                </div>
                                {/*<div className="text-end">*/}
                                {/*    <button*/}
                                {/*        className="tw-px-4 tw-py-1.5 tw-rounded-sm tw-bg-dark-5 tw-text-sm tw-font-semibold"*/}
                            ...
                            <div className="tw-flex">
                                <div className="tw-flex-1">
                                    <div className="tw-flex">
                                        ...
                                        {!userInfo?.phone && (
                                            <div
                                                className="tw-flex tw-justify-center tw-items-center tw-w-5 tw-h-5 tw-rounded-full tw-bg-white">
                                    ...
                                    <p>
                                        {isLoading ? "Loading..." : (userInfo?.phone || "You haven't added a phone number at all")}
                                    </p>
                                </div>
                                <div className="text-end">
                                    <button
                ...
                {userInfo?.auth_type === 'USERNAME_PASSWORD' && (
                    <div className="tw-mb-10">

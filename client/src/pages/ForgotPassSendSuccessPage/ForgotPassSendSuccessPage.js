...
const ForgotPassSendSuccessPage = () => {
            ...
            <div className="tw-bg-white tw-w-[500px] tw-rounded-lg tw-text-center">
                ...
                <div className="tw-px-5 sm:tw-px-14 tw-py-16 tw-pb-8">
                    ...
                    <p className="tw-text-gray-600 tw-text-sm tw-font-medium">
                        We've already sent out the reset password link to email <b
                        className="tw-font-bold tw-text-gray-800">{email}</b>. Please check it and confirm it's really
                        you.
                    </p>
                    <button
...
export default ForgotPassSendSuccessPage;

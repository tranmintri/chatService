...
io.on("connection", (socket) => {
    ...
    socket.on("acceptFriendRequest", (data) => {
        ...
        // updatefen
        socket.to(onlineUsers.get(data.sender)).emit("updateFriend", postData);
    });
    ...
    socket.on("rejectFriendRequest", (data) => {
        ...
        socket.to(onlineUsers.get(data.sender)).emit("rejectFriend", postData);
    ...
    socket.on("cancelFriendRequest", (data) => {
        ...
        socket.to(onlineUsers.get(data.receiver)).emit("cancelFriend", postData);
